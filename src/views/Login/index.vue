<template>
    <div class="overflow-hidden">
        <div class="flex flex-row">
            <div class="flex lg:w-3/5 w-full flex-row md:w-1/2 hidden md:flex hidden md:block">
                <div class="flex flex-col md:flex-row h-screen">
                    <img src="../../../src/assets/images/twitter.png" alt="imagem do twitter" class="w-full sm:block flex">
                </div>
            </div>
            <div class="flex flex-col justify-center lg:w-4/5 w-full md:w-1/2">
                <div class="mb-1 mt-3 ml-2 mb-12 px-6">
                    <button class="focus:outline-none h-30 w-30  text-5xl  rounded-full text-blue">
                ...
                <div class="container ml-12 px-9 h-12 mb-9">
                    <button class="px-8 py-7 lg:text-2xl md:text-1xl text-center h-15 w-4/6 font-bold rounded-full bg-blue hover:shadow focus:outline-none text-1xl ">Inscrever-se</button>
                </div>
                <div class="container py-5 ml-11  px-9">
                    <button class="px-8 py-5 lg:text-2xl md:text-1xl text-center h-15 w-4/6 font-bold rounded-full bg-lighter hover:bg-blue focus:outline-none text-1xl">Entrar</button>
                </div>
            </div>
        </div>
